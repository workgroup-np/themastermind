...
if (!defined('ABSPATH')) {echo '<h1>Forbidden</h1>'; exit();} ?>
  ...
  <?php if (get_next_post_link('&laquo; %link', '%title', 1) OR get_previous_post_link('%link &raquo;', '%title', 1)) : ?>
      ...
      <div class="prev-next-btn" style="display:none;">
        ...
        <ul class="pager">
          ...
          previous_posts_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous feature', 'mastermind' ) . '</span> %title' ); ?>
          ...
          next_posts_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next feature', 'mastermind' ) . '</span>' ); ?>
  ...
  $defaults = array(
    ...
    'nextpagelink'     => __( 'Next page' ,'mastermind'),

    'previouspagelink' => __( 'Previous page','mastermind' ),
