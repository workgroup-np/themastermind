...
$metaboxes = array(
    'link' => array(
        'title' => __('Link Settings', 'mastermind'),
        'applicableto' => 'post',
        'location' => 'normal',
        ...
        'fields' => array(
            'link_title' => array(
                'title' => __('Link Title:', 'mastermind'),
                'type' => 'text',
                'description' => '',
                'size' => 60
            ),
            'link_url' => array(
                'title' => __('link url:', 'mastermind'),
                'type' => 'text',
                'description' => '',
                'size' => 60
            )
    ...
    'video_code' => array(
        'title' => __('Video Settings', 'mastermind'),
        'applicableto' => 'post',
        'location' => 'normal',
    ...
    'audio_code' => array(
        'title' => __('Audio Settings', 'mastermind'),
        'applicableto' => 'post',
        'location' => 'normal',
    ...
    'quote_author' => array(
        'title' => __('Quote Settings', 'mastermind'),
        'applicableto' => 'post',
        'location' => 'normal',
        ...
        'fields' => array(
            ...
            'q_content' => array(
                'title' => __('Quote content:', 'mastermind'),
                'type' => 'textarea',
                'description' => '',
                'size' => 20
            ),
            ...
            'q_author' => array(
                'title' => __('quote author:', 'mastermind'),
                'type' => 'text',
                'description' => '',
                'size' => 20
            )
...
add_action( 'add_meta_boxes', 'mastermind_add_post_format_metabox' );

function mastermind_add_post_format_metabox() {
    global $metaboxes;

    if ( ! empty( $metaboxes ) ) {
        foreach ( $metaboxes as $id => $metabox ) {
            add_meta_box( $id, $metabox['title'], 'mastermind_show_metaboxes', $metabox['applicableto'], $metabox['location'], $metabox['priority'], $id );
        }
    }
}

function mastermind_show_metaboxes( $post, $args ) {
    global $metaboxes;
...
add_action( 'save_post', 'mastermind_save_metaboxes' );

function mastermind_save_metaboxes( $post_id ) {
    global $metaboxes;
...
add_action( 'admin_print_scripts', 'mastermind_display_metaboxes', 1000 );
function mastermind_display_metaboxes() {
    global $metaboxes;
...
add_filter( 'cmb_meta_boxes', 'mastermind_cmb_metaboxes' );
function mastermind_cmb_metaboxes( array $meta_boxes ) {

    $prefix = 'mastermind_';

     $meta_boxes['page_metabox'] = array(
        'id'         => 'page_metabox',
        'title'      => __( 'Creativ Page Settings', 'mastermind' ),
        ...
        'fields'     => array(
            array(
                ...
                'name'    => __( 'Select Template Background Color','mastermind'),
                'desc' => __('Background color of selected template will change accordingly except builder templates', 'mastermind') ,
                'type'    => 'select',
                'options' => array(
            ...
            array(
                ...
                'name'    => __( 'Page Breadcrumb Options','mastermind'),
                'type'    => 'select',
                'options' => array(
            ...
            array(
                'name' => __('Background Breadcrumb Image', 'mastermind') ,
                'desc' => __('Upload an image or enter a URL. This works only for Breadcrumb Background Image style.', 'mastermind') ,
            ...
            array(
                'name' =>  __( 'Hide Social Icons', 'mastermind' ),
    ...
    $meta_boxes['post_metabox'] = array(
        'id'         => 'post_metabox',
        'title'      => __( 'Creativ Post Page Settings', 'mastermind' ),
     ...
     $meta_boxes['portfolio_metabox'] = array(
        ...
        'title'      => __( 'Custom Portfolio Options', 'mastermind' ),
    ...
    $meta_boxes['event_metabox'] = array(
            'id'         => 'event_metabox',
            'title'      => __( 'Custom Event Options', 'mastermind' ),
            'pages'      => array( 'event' ),
            'context'    => 'normal',
            'normal'   => 'high',
            'show_names' => true, // Show field names on the left
     ...
     $meta_boxes['menu_metabox'] = array(
            'id'         => 'menu_metabox',
            'title'      => __( 'Custom Menu Options', 'mastermind' ),
            'pages'      => array( 'menu' ),
            'context'    => 'normal',
            'normal'   => 'high',
            'show_names' => true, // Show field names on the left
